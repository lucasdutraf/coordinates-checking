...
CITIES = {
    ...
    "Brasilia": [(-15.527791, -48.205135), (-16.045813, -48.275706), (-16.040534, -47.319257), (-15.517205, -47.423697)],
    "Porto Alegre": [(-29.985271, -51.201407), (-30.122561, -51.257062), (-30.136814, -51.143003), (-29.990029, -51.111396)],
}

def is_inside(x: float, y: float, coordinates: list) -> bool:
...
if __name__ == "__main__":
    # Tests
    assert city_name(-15.618408, -47.658203) == "Brasilia"
